...
export const CustomerAgent: React.FC = () => {
  ...
  return (
    <div className="flex flex-col p-2 bg-gradient-to-br from-gray-800 to-gray-900/80 rounded-xl shadow-lg border border-purple-500/20 h-[200px]">
      <div className="flex items-center gap-2">
        <Users className="w-4 h-4 text-purple-500" aria-hidden="true" />
        <h2 className="text-sm font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-blue-600">
          Customer Agent
        </h2>
      </div>
            ...
            <div className="flex items-center justify-between mb-1">
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-1 bg-purple-500/20 px-2 py-0.5 rounded-full">
                  ...
                  <span className="text-[8px] text-purple-300">{order.destination.split(' ')[0]}</span>
                </div>
              </div>
